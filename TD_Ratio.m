...
% % TWO WAY ANOVA
[~,~,lHtdS2] = anovan(results2way.lHtd, {lhtdStroke,lhtdEE},'display','off');
[~,~,lLtdS2] = anovan(results2way.lLtd, {lltdStroke,lltdEE},'display','off');
[~,~,rHtdS2] = anovan(results2way.rHtd, {rhtdStroke,rhtdEE},'display','off');
[~,~,rLtdS2] = anovan(results2way.rLtd, {rltdStroke,rltdEE},'display','off');
[~,~,lNumS2] = anovan(results2way.lNum, {nStroke,nEE},'display','off');
[~,~,rNumS2] = anovan(results2way.rNum, {nStroke,nEE},'display','off');
[~,~,lRS2] = anovan(results2way.lR,   {nStroke,nEE},'display','off');
[~,~,rRS2] = anovan(results2way.rR,   {nStroke,nEE},'display','off');
