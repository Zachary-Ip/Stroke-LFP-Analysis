...
% Load file
activefilepath = ['C:\Users\ipzach\Documents\Converted\' SpkInfo{group,1} '_' num2str(animal)  '\concatenatedLFP.mat'];
load(activefilepath);
...
plot(timeC,Theta_C,'Color',Lin.mBlue); ylabel('\theta (3-7 Hz)')
...
plot(timeS,Theta_S,'Color',Lin.mOrange)
title('Stroke');
...
plot(timeC,Delta_C,'Color',Lin.dBlue);ylabel('\delta (0.1-3 Hz)')
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf -20000 20000])
box off
ax4 = subplot('Position',[0.55 0.6333 0.37 0.1333]);
plot(timeS,Delta_S,'Color',Lin.dOrange)
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf -20000 20000])
box off
...
plot(timeC,S_Theta_C,'Color',Lin.mBlue), ylabel({'\theta envelope'})
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 10000])
box off

ax10 = subplot('Position',[0.55 0.5 0.37 0.1333]);
plot(timeS,S_Theta_S,'Color',Lin.mOrange)
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 10000])
box off

ax11 = subplot('Position',[0.15 0.3666 0.37 0.1333]);
plot(timeC,S_Delta_C,'Color',Lin.dBlue);ylabel('\delta envelope')
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 10000])
box off

ax12 = subplot('Position',[0.55 0.3666 0.37 0.1333]);
plot(timeS,S_Delta_S,'Color',Lin.dOrange)
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 10000])
box off
...
plot(timeC,Theta_Delta_C,'Color', Lin.dBlue);ylabel({'\theta / \delta'})
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 3])
box off

ax14 = subplot('Position',[0.55 0.2333 0.37 0.1333]);
plot(timeS,Theta_Delta_S,'Color', Lin.dOrange)
set(gca, 'xtick',[],'ytick',[],'FontSize',14)
axis([0  inf 0 3])
box off
...
alpha(0.3)
plot(timeC, S_Theta_Delta_C,'Color', Lin.mBlue,'LineWidth',1.5);
...
alpha(0.3)
plot(timeS, S_Theta_Delta_S,'Color', Lin.mOrange,'LineWidth',1.5);
