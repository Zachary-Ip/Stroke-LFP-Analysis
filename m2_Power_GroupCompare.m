...
rData(1:6,2) = source{4}.R(4:end,group,layer);
rData(1:9,3) = source{3}.R([1:4 6 8:end],group,layer);

lData = NaN(9,3);
lData(1:8,1) = source{1}.L(5:end,group,layer);
lData(1:6,2) = source{4}.L(4:end,group,layer);
lData(1:9,3) = source{3}.L([1:4 6 8:end],group,layer);
