...
for i = 8:10
    ...
    [~,rT2,rS2] = anovan(rData2,{treatLabel,groupLabel},'model','interaction','display','off');
    [~,lT2,lS2] = anovan(lData2,{treatLabel,groupLabel},'model','interaction','display','off');
    ...
    save(['C:\Users\ipzach\Documents\MATLAB\Stats\PAC\H_' file '_P' num2str(phaseLow) '-' num2str(phaseHigh) '_A' num2str(ampLow) '-' num2str(ampHigh) '_G'],...
